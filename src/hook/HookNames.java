...
public enum HookNames {
    ...
    BASIC_DETECTION_DISABLE(2,new Vec2(1500,2000),350,0,4*Math.PI,ActuatorOrder.BASIC_DETECTION_DISABLE),
    ACTIVE_BRAS_AVANT_ABEILLE(3, new Vec2(1500,2000), 350, 0, 4*Math.PI, ActuatorOrder.ACTIVE_BRAS_AVANT_POUR_ABEILLE),
    ACTIVE_BRAS_ARRIERE_ABEILLE(4, new Vec2(1500,2000), 350, 0, 4*Math.PI, ActuatorOrder.ACTIVE_BRAS_ARRIERE_POUR_ABEILLE),
    ;
