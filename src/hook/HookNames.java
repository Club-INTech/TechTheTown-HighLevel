...
public enum HookNames {
    ...
    ACTIVE_BRAS_AVANT_ABEILLE_SYMETRIQUE(4, new Vec2(-1400,1800), 500, 0, 2*Math.PI, ActuatorOrder.ACTIVE_BRAS_AVANT_POUR_ABEILLE),
    ACTIVE_BRAS_ARRIERE_ABEILLE_SYMETRIQUE(5, new Vec2(-1400,1800), 500, 0, 2*Math.PI, ActuatorOrder.ACTIVE_BRAS_ARRIERE_POUR_ABEILLE),
    ;
