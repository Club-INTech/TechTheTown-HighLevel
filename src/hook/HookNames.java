...
public enum HookNames {
    ...
    BASIC_DETECTION_ENABLE(4,new Vec2(1400,1800),500,0,4*Math.PI,ActuatorOrder.BASIC_DETECTION_ENABLE),
    BASIC_DETECTION_DISABLE(4,new Vec2(1400,1800),500,0,4*Math.PI,ActuatorOrder.BASIC_DETECTION_DISABLE)
    ;
