...
public enum HookNames {
    ...
    ACTIVE_BRAS_AVANT_ABEILLE(2, new Vec2(1500,2000), 5, ActuatorOrder.ACTIVE_BRAS_AVANT_POUR_ABEILLE),
    ACTIVE_BRAS_ARRIERE_ABEILLE(3, new Vec2(1500,2000), 5, ActuatorOrder.ACTIVE_BRAS_ARRIERE_POUR_ABEILLE),
    ;
