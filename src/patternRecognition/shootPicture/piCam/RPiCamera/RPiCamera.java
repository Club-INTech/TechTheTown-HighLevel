package patternRecognition.shootPicture.piCam.RPiCamera;
...
/**
 * RPiCamera.RPiCamera is used to access the Raspberry Pi Camera and take still photos.
 * There are a variety of different settings that may be changed to modify images
 * taken by an RPiCamera.RPiCamera instance, such as width, height, AWB, DRC, and the resulting
 * image's encoding type (jpg, bmp, png, gif).
 * <p>
 * Although it provides additional features and support for Java specific operations, 
 * RPiCamera.RPiCamera is essentially a wrapper class for executing the raspistill software from
 ...
 *
 * // Create RPiCamera.RPiCamera instance
 * RPiCamera.RPiCamera camera = new RPiCamera.RPiCamera(saveDir)
 *     .setWidth(150)   // Set width property of RPiCamera.RPiCamera.
 *     .setHeight(150); // Set height property of RPiCamera.RPiCamera.
 *
...
public class RPiCamera {
	...
	/**
	 * Creates new RPiCamera.RPiCamera and sets its save directory. The resulting RPiCamera.RPiCamera will have a
     * default image width and height of 500.
	 * 
	 * @param saveDir A String specifying the directory for RPiCamera.RPiCamera to save images.
	 * @throws FailedToRunRaspistillException 
	 */
	public RPiCamera(String saveDir) throws FailedToRunRaspistillException {
		...
		try {
			...
			throw new FailedToRunRaspistillException(
					"RPiCamera.RPiCamera failed to run raspistill. The JRPiCam library relies on"
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 * specified name to the RPiCamera.RPiCamera's save directory ("/home/pi/Pictures" by
	 * default). The image's encoding will be the same as the RPiCamera.RPiCamera's encoding
	 * setting (JPEG by default).
	 * <p>
	 * Usage Example:
	 * <pre>
	 *{@code
	 * // Create an RPiCamera.RPiCamera instance using default constructor, which sets the
	 * // save directory to "/home/pi/Pictures".
	 * RPiCamera.RPiCamera piCamera = new RPiCamera.RPiCamera()
...
// 						"Desktop" + File.separator + "RPiCamera.RPiCamera.out"));
	...
	/**
	 * Takes an image and saves it under the specified name to the RPiCamera.RPiCamera's save
	 * directory ("/home/pi/Pictures" by default). The image's encoding will be the 
	 * same as the RPiCamera.RPiCamera's encoding setting (JPEG by default).
	 * <p>
	 * Usage Example:
	 * <pre>
	 *{@code
	 ...
	 * encoding will be the same as the RPiCamera.RPiCamera's encoding setting (JPEG by default).
	 * <p>
	 * Usage Example:
	 * <pre>
	 *{@code
...
// 		--------------------------------------------------------------------------
	 ...
	 * the RPiCamera.RPiCamera's encoding setting (JPEG by default).
	 * <p>
	 * Usage Example:
	 * <pre>
	 *{@code
	 ...
	 * <pre>
	 *{@code
	 * // Creating and setting up an RPiCamera.RPiCamera
	 * RPiCamera.RPiCamera piCamera = new RPiCamera.RPiCamera()
	 *      .turnOffPreview()
	 *      .setTimeout(1);
	 *
...
// 				"Desktop" + File.separator + "RPiCamera.RPiCamera.out"));
	 ...
	 * specified filename to the RPiCamera.RPiCamera's save directory. Length of time to timelapse for may
	 ...
	 *     .setLinkLatestImage(true, "/home/pi/Pictures/linkfile.png"); // Set RPiCamera.RPiCamera to link images to "linkFile.png"
	 * // Begin timelapse
	 * piCamera.timelapse(
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	/**
	 * Stops any raspistill processes being run by RPiCamera.RPiCamera.
	 */
	public void stop() {
		if (p != null)
			p.destroy();
	...
	/**
	 * Gets the raspistill command previously executed by the RPiCamera.RPiCamera. If no commands have
	...
	/**
	 * Sets the RPiCamera.RPiCamera's save directory.
	 * 
	 * @param saveDir String containing directory for RPiCamera.RPiCamera to save images to.
	 */
...
// 	}
	...
	/**
	 * Sets all RPiCamera.RPiCamera options to their default settings, overriding any previously
	 * set options.
	 */
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 * <br>
	 * Sets ISO of RPiCamera.RPiCamera (100 to 800).
	 * 
...
// 	TODO: MAKE METHOD FOR EVCOMPENSATION (-25 - 25?), ONLY FOR VIDEO
	...
	/**
	 * Sets exposure mode of RPiCamera.RPiCamera. Certain modes may not be supported
	...
	/**
	 * Sets colour effect of RPiCamera.RPiCamera. The specified U and V parameters (0 to 255)
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
	...
	/**
	 * Sets width of images taken by RPiCamera.RPiCamera. Note that this setting
	...
	/**
	 * Sets height of images taken by the RPiCamera.RPiCamera. Note that this settings
     * can be overriden by the {@link #takeStill(String, int, int)}  and {@link #takeBufferedStill(int, int)} methods.
	 *
	...
	/**
	 * Appends raw Bayer data from the RPiCamera.RPiCamera to the image's JPEG metadata.
	 * 
	...
	/**
	 * Sets the RPiCamera.RPiCamera's timeout. RPiCamera.RPiCamera runs for the specified number of
	 * milliseconds before taking the image. Default value is 5 seconds. If timeout 
	 * value is 0, then RPiCamera.RPiCamera will continue to run indefinitely (but can be stopped
	...
	/**
	 * Turns on burst mode for RPiCamera.RPiCamera. Prevents raspistill from switching
	...
	/**
	 * Turns off burst mode for RPiCamera.RPiCamera.
	 */
     ...
     * E.g.
     *<pre>{@code
     * RPiCamera.RPiCamera camera = new RPiCamera.RPiCamera()
     *    .setDateTimeOn();
