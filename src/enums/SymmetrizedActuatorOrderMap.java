...
public class SymmetrizedActuatorOrderMap
{
    ...
    public SymmetrizedActuatorOrderMap()
    {
        ...
        mCorrespondenceMap.put(ActuatorOrder.FERME_LA_PORTE_AVANT_UNPEU,ActuatorOrder.FERME_LA_PORTE_AVANT_UNPEU);
        //ARRIERE
        ...
        mCorrespondenceMap.put(ActuatorOrder.FERME_LA_PORTE_ARRIERE_UNPEU,ActuatorOrder.FERME_LA_PORTE_ARRIERE_UNPEU);
        ...
        mCorrespondenceMap.put(ActuatorOrder.SUS_ON,ActuatorOrder.SUS_ON);
        mCorrespondenceMap.put(ActuatorOrder.SUS_OFF,ActuatorOrder.SUS_OFF);
