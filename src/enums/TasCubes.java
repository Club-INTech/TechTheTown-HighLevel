...
public enum TasCubes{
    ...
    TAS_BASE(0,new Vec2(640,540), new Vec2(655,550), //MatchScript 0
    ...
    TAS_STATION_EPURATION(2,new Vec2(395,1500), new Vec2(390,1510), //MatchScript 0
            new Vec2(395,1500), new Vec2(390,1510), //MatchScript 2
            new Vec2(395,1500), new Vec2(390,1510)), //MatchScript 42
