...
public abstract class AbstractScript implements Service 
{
	 ...
	 */
	public void goToThenExec( GameState actualState,int versionToExecute) throws UnableToMoveException, BadVersionException, ExecuteException, BlockedActuatorException, PointInObstacleException {
